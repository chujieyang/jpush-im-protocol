...
public class BaseResponse{
	...
	public BaseResponse(int version, long rid, long juid){
	 ...
	 * 构建消息头
	 */
	public void buidResponseHeader() {
	 ...
	 * @throws KKException 
	 */
	public byte[] getResponsePackage(){
		this.buidResponseHeader();
		this.buidResponseBody();
